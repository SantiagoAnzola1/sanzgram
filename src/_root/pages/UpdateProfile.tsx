...
const UpdateProfile = () => {
    ...
    const { user, isLoading: isUserLoading, isAuthenticated: isUserAuthenticated } = useUserContext()
            ...
            <div className='flex flex-1'>
                <div className='common-container '>
                    ...
                    {isUserAuthenticated ? (
                        ...
                        <p className='text-light-4 mt-10 text-center w-full'>Not authenticated</p>
                    )}
                </div>
            </div>


            <div className='min-w-[400px] min-h-screen overflow-y-auto max-h-44 hidden xl:flex  border-l-dark-4 xl:flex-col border-l-2 xl:align-center gap-10 py-10 px-6'>
